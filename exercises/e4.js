...
var splitName = splitFirstAndLastNames('John Smith');
...
var howOld = personAge(personObject);
...
var findName = isNameInArray(['Jon', 'Michael', 'Andrey'], 'Michael');
var findName2 = isNameInArray(['Jon', 'Michael', 'Andrey'], 'James');
